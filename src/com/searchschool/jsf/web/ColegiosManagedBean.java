...
@SessionScoped
public class ColegiosManagedBean implements Serializable {
	...
	public void sortSchools() {
		...
		{
			schools = schoolImpl.sortByField("qvaloracionPromedio", false);
			return;
		}
		if(selectedField.equals("Nombre"))
		{
			schools = schoolImpl.sortByField("ncolegio", true);
			return;
		}
		if(selectedField.equals("Tipo de colegio"))
		{
			schools = schoolImpl.sortByField("tipoColegio", true);
			return;
		}
	}
	...
	public String showDetails(){
		...
		HttpSession session = (HttpSession)context.getExternalContext().getSession(true);  
		   session.setAttribute("colegio", selectedSchool);  
		return "detalles";
	}
	...
	public void setSelectedSchool(Colegio selectedSchool) {
		...
		System.out.println("Numero de convenios");
		System.out.println(selectedSchool.getColegioUsuarios().size());
	}
