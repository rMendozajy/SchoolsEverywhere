...
@ManagedBean (name="ESPECIAL")
@SessionScoped
public class EspecialManagedBean implements Serializable {
	...
	public void sortSchools() {
		...
		{
			schools = schoolImpl.sortTypeByField("Educacion Especial","qvaloracionPromedio", false);
			return;
		}
		if(selectedField.equals("Nombre"))
		{
			schools = schoolImpl.sortTypeByField("Educacion Especial","ncolegio", true);
			return;
		}
		if(selectedField.equals("Tipo de colegio"))
		{
			schools = schoolImpl.sortTypeByField("Educacion Especial","tipoColegio", true);
			return;
		}
	}
