...
@ManagedBean (name="NIDO")
@SessionScoped
public class NidoManagedBean implements Serializable {
	...
	public void sortSchools() {
		...
		{
			schools = schoolImpl.sortTypeByField("Nidos","qvaloracionPromedio", false);
			return;
		}
		if(selectedField.equals("Nombre"))
		{
			schools = schoolImpl.sortTypeByField("Nidos","ncolegio", true);
			return;
		}
		if(selectedField.equals("Tipo de colegio"))
		{
			schools = schoolImpl.sortTypeByField("Nidos","tipoColegio", true);
			return;
		}
	}
