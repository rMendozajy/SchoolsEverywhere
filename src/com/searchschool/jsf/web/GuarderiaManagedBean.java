...
@ManagedBean (name="GUARDERIA")
@SessionScoped
public class GuarderiaManagedBean implements Serializable {
	...
	public void sortSchools() {
		...
		{
			schools = schoolImpl.sortTypeByField("Guarderias","qvaloracionPromedio", false);
			return;
		}
		if(selectedField.equals("Nombre"))
		{
			schools = schoolImpl.sortTypeByField("Guarderias","ncolegio", true);
			return;
		}
		if(selectedField.equals("Tipo de colegio"))
		{
			schools = schoolImpl.sortTypeByField("Guarderias","tipoColegio", true);
			return;
		}
	}
